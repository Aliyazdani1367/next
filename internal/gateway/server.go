...
func NewServer(cfg Config) (*Server, error) {
	...
	mux.HandleFunc("/__next_go/healthz", func(w http.ResponseWriter, _ *http.Request) {
		w.Header().Set("Content-Type", "text/plain; charset=utf-8")
		_, _ = w.Write([]byte("ok\n"))
	})
	mux.HandleFunc("/__next_go/api_healthz", func(w http.ResponseWriter, r *http.Request) {
		if apiHandler == nil {
...
func apiHealthRequest(r *http.Request) *http.Request {
	...
	req.URL.Path = "/__next_api/healthz"
	req.URL.RawPath = ""
	req.URL.RawQuery = ""
	return req
}
