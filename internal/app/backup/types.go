...
const (
	...
	Version   = 1
	Extension = ".rbbackup"
	MediaType = "application/vnd.next.backup"
	...
	DisabledDetail = "Next backup and import is available only on binary installations. Migrate this panel to the binary version before using backup or restore from the web UI."
)
