...
:root {
	color-scheme: dark;
	--next-docs-bg: #050912;
	--next-docs-panel: #0d1524;
	--next-docs-panel-soft: #111c2d;
	--next-docs-border: #26364f;
	--next-docs-text: #e8edf7;
	--next-docs-muted: #a6b3c8;
	--next-docs-code: #18243a;
}

html,
body {
	background: var(--next-docs-bg) !important;
	color: var(--next-docs-text) !important;
}

.swagger-ui {
	color: var(--next-docs-text);
}
...
.swagger-ui section.models {
	...
	border-color: var(--next-docs-border) !important;
}
...
.swagger-ui .responses-inner h5 {
	color: var(--next-docs-muted) !important;
}
...
.swagger-ui .opblock {
	background: var(--next-docs-panel) !important;
	border-color: var(--next-docs-border) !important;
...
.swagger-ui .opblock-title_normal {
	background: var(--next-docs-panel-soft) !important;
	border-color: var(--next-docs-border) !important;
	box-shadow: none !important;
}
...
.swagger-ui input,
.swagger-ui select {
	background: var(--next-docs-code) !important;
	color: var(--next-docs-text) !important;
	border-color: var(--next-docs-border) !important;
}
...
.swagger-ui .dialog-ux .modal-ux {
	background: var(--next-docs-panel) !important;
	border: 1px solid var(--next-docs-border) !important;
...
.swagger-ui .dialog-ux .modal-ux-header {
	background: var(--next-docs-panel-soft) !important;
	border-bottom: 1px solid var(--next-docs-border) !important;
	color: var(--next-docs-text) !important;
}
...
.swagger-ui .dialog-ux .modal-ux-header .close-modal svg {
	fill: var(--next-docs-text) !important;
}
