...
type V2rayNShadowsocksProfile struct {
	...
	CipherSuites         string                          `json:"CipherSuites,omitempty"` // Next/xray-json extension.
...
type V2rayNShadowsocksTransportExtra struct {
	...
	KCPTTI        int    `json:"KcpTti,omitempty"`          // Next/xray-json extension.
	Heartbeat     int    `json:"HeartbeatPeriod,omitempty"` // Next/xray-json extension.
}
...
// existing Xray-aware SS URL representation used only inside Next.
