...
```shell
CUSTOM_TEMPLATES_DIRECTORY="/var/lib/next/templates/"
```
...
```shell
mkdir /var/lib/next/templates/sing-box
```
...
```
Now, restart your Next and enjoy.

If you have already changed your env variables, and you want to just update the template files, there is no need to restart Next.
