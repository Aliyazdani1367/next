...
Thanks for considering a contribution to Next.

## Questions

Please avoid opening issues for support questions. Use one of these channels instead:

- Telegram channel: [@aliking1367_next](https://t.me/aliking1367_next)
...
- Next version, install mode, database type, node version, and Xray version.
...
```text
.
|-- cmd/                 # Next server and CLI entrypoints
