...
import (
	...
	admincore "github.com/aliking1367/next/internal/app/admin"
	"github.com/aliking1367/next/internal/app/migrations"
	"github.com/aliking1367/next/internal/platform/db"
...
const (
	envAdminPassword = "NEXT_ADMIN_PASSWORD"
...
func printUsage() {
	fmt.Println("Usage: next cli <command> [options]")
	fmt.Println()
...
func printAdminUsage() {
	fmt.Println("Usage: next cli admin <command> [options]")
	fmt.Println()
	fmt.Println("Commands:")
...
func printUserUsage() {
	fmt.Println("Usage: next cli user <command> [options]")
	fmt.Println("Commands: list, set-owner")
}

func printSubscriptionUsage() {
	fmt.Println("Usage: next cli subscription <command> [options]")
	fmt.Println("Commands: get-link, get-config")
}

func printMigrateUsage() {
	fmt.Println("Usage: next migrate <command>")
...
func envCandidates() []string {
	candidates := []string{}
	if explicit := strings.TrimSpace(os.Getenv("NEXT_ENV_FILE")); explicit != "" {
