												...
												<SimpleGrid columns={{ base: 1, md: 2 }} spacing={4}>
													...
													<FormControl display="flex" alignItems="center">
														{ovLabel(
															...
															"Record OpenVPN session traffic and report it to the same Next user quota/accounting pipeline.",
															{ mb: 0 },
														)}
												...
												<SimpleGrid columns={{ base: 1, md: 2 }} spacing={4}>
													...
													<FormControl display="flex" alignItems="center">
														{ovLabel(
															...
															"Record WireGuard peer traffic and report it to the same Next user quota/accounting pipeline.",
															{ mb: 0 },
														)}
												...
												<SimpleGrid columns={{ base: 1, md: 3 }} spacing={4}>
													...
													<FormControl display="flex" alignItems="center">
														{ovLabel(
															...
															"Report live usage to Next quota accounting.",
															{ mb: 0 },
														)}
														<Switch {...register("raAccountingEnabled")} />
													</FormControl>
												...
												<SimpleGrid columns={{ base: 1, md: 2 }} spacing={4}>
													...
													<FormControl display="flex" alignItems="center">
														{ovLabel(
															...
															"Record L2TP session traffic and report it to the same Next user quota/accounting pipeline.",
															{ mb: 0 },
														)}
