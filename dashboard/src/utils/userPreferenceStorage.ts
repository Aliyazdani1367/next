const NUM_USERS_PER_PAGE_LOCAL_STORAGE_KEY = "next-num-users-per-page";
const NUM_ADMINS_PER_PAGE_LOCAL_STORAGE_KEY = "next-num-admins-per-page";
const NUM_NODES_PER_PAGE_LOCAL_STORAGE_KEY = "next-num-nodes-per-page";
const NUM_RECENT_ACTIONS_PER_PAGE_LOCAL_STORAGE_KEY =
	"next-num-recent-actions-per-page";
const NUM_NODES_PER_PAGE_COOKIE_KEY = "next-num-nodes-per-page";
