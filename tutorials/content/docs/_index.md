...
weight: 1
description: "Next panel to create, manage, and troubleshoot users, admins, and nodes. Main areas: Dashboard, Users, Admins, Services, Hosts, Nodes, Integrations, My Account."
cascade:
  params:
    noindex: true
---
...
Next panel to create, manage, and troubleshoot users, admins, and nodes. Main areas: Dashboard, Users, Admins, Services, Hosts, Nodes, Integrations, My Account.
...
- [GitHub](https://github.com/nextpanel/next)
- [Telegram](https://t.me/nextpanel)
